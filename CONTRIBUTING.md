...
6. When writing **code**: **TDD** is mandatory; follow **DRY**, **KISS**, and **YAGNI** (native asset spec gate is lifted — see [freeze](documentation/specification/native-assets-v0-freeze.md)).
