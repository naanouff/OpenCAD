...
All required initial v0 specs are published. See [specification/native-assets-v0-freeze.md](specification/native-assets-v0-freeze.md).

**SDK / application development is now allowed** (TDD + contribution rules).

| Format | Spec doc | Issue |
|--------|----------|-------|
...
| `.cadompart` | [cadompart-v0.md](specification/cadompart-v0.md) (**v0.2** exhaustive) | [#45](https://github.com/naanouff/OpenCAD/issues/45) |
...
Bootstrap monorepo + TypeScript SDK (`decode`/`encode`, overrides, pass-through) with **TDD**.
