...
| `.cadomesh` | [cadomesh-v0.md](specification/cadomesh-v0.md) | [#31](https://github.com/naanouff/OpenCAD/issues/31) — **draft in progress / done when closed** |
| `.cadompart` | `cadompart-v0.md` | [#32](https://github.com/naanouff/OpenCAD/issues/32) |
| `.cadomat` | `cadomat-v0.md` | [#33](https://github.com/naanouff/OpenCAD/issues/33) |
